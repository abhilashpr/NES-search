...
<div class="loginform text-left">
  <div class="mb-3 ">
    ...
    <input type="number" class="form-control border-none box-input-card  border-none" name="phone" placeholder="Phone Number" >
  </div>
  <div class="mb-3">
...
<a href="<?php echo base_url(); ?>login/register">Create New Account</a>
            </div>
        </div>
    </div>
