...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2021 at 03:32 PM
...
--
-- Table structure for table `nes_stocks`
--

CREATE TABLE `nes_stocks` (
  `id` int(11) NOT NULL,
  `Name` text NOT NULL,
  `Current_Market_Price` double NOT NULL,
  `Market_Cap` double NOT NULL,
  `Stock_P_E` double NOT NULL,
  `Dividend_Yield` double NOT NULL,
  `ROCE` double NOT NULL,
  `ROE_Previous_Annum` double NOT NULL,
...
--
-- Dumping data for table `nes_stocks`
--

INSERT INTO `nes_stocks` (`id`, `Name`, `Current_Market_Price`, `Market_Cap`, `Stock_P_E`, `Dividend_Yield`, `ROCE`, `ROE_Previous_Annum`, `Debt_to_Equity`, `EPS`, `Reserves`, `Debt`) VALUES
...
INSERT INTO `users` (`id`, `name`, `password`, `phone_number`) VALUES
(1, 'abhiaks', 'abhi', '98761'),
(2, 'abhi', 'abhi', '963'),
(3, 'abhi', '963', '963'),
(4, 'abhilash', 'abhi', '9633059779');
...
--
-- Indexes for table `nes_stocks`
--
ALTER TABLE `nes_stocks`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `nes_stocks`
--
ALTER TABLE `nes_stocks`
